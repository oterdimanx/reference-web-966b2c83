    ...
    <header className="bg-white dark:bg-gray-900 border-b border-slate-200 dark:border-gray-700 relative">
      <div className="container mx-auto flex justify-between items-center p-4">
        <Link to="/" className="flex items-center space-x-2">
          {/* Show logo image on desktop (md and up), text on smaller screens */}
          <img 
            src="/lovable-uploads/1741536e-ddb0-4a3b-9688-56cf3cbe998e.png" 
            alt="Reference-Web Logo" 
            className="hidden md:block h-10 w-auto hover:opacity-80 transition-opacity"
          />
          <span className="md:hidden text-2xl font-bold bg-gradient-to-r from-rank-teal to-blue-600 text-transparent bg-clip-text">
            {t('homepage', 'title')}
          </span>
        </Link>
